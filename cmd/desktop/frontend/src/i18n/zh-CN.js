export default {
    ...
    modal: {
        ...
        modelHelpOpenAI2: '可选：覆盖请求中指定的 OpenAI 模型（Responses API）',
        modelHelpGemini: '可选：覆盖请求中指定的 Gemini 模型',
        remark: '备注',
        remarkHelp: '可选：为此端点添加备注说明',
        cancel: '取消',
        save: '保存',
        invalidFormat: '格式无效',
        manageTokenPool: '管理令牌池',
        close: '关闭',
        changePort: '修改端口',
        port: '端口',
        ...
        fetchModelsNoAuthKey: '令牌池模式不支持检测模型',
        fetchModelsUsingTokenPool: '令牌池模式将使用可用凭据检测模型',
    ...
    tokenPool: {
        title: '令牌池',
        codexProxy: 'Codex 代理',
        codexProxyTip: '仅用于 Codex 请求和凭证刷新',
        proxyUpdated: 'Codex 代理已更新',
        proxyCleared: 'Codex 代理已清空',
        proxyLoadFailed: '加载 Codex 代理失败：{error}',
        proxySaveFailed: '保存 Codex 代理失败：{error}',
        batchImportJson: '批量导入 JSON',
        overwriteExisting: '覆盖已有 account/email',
        pasteJsonPlaceholder: '粘贴单个对象 / 数组 / {"items":[...]}',
        importFiles: '导入文件',
        refreshLimits: '刷新限额',
        account: '账户',
        email: '邮箱',
        ...
        actions: '操作',
        noCredentials: '暂无凭证',
        usingCredentialPool: '使用凭证池',
        view: '查看',
        enable: '启用',
        disable: '禁用',
        more: '更多',
        activate: '激活',
        refreshLimitsAction: '刷新限额',
        refreshToken: '刷新令牌',
        usage: '用量',
        updateToken: '更新令牌',
        delete: '删除',
        ...
        accessTokenPlaceholder: '在此粘贴 access_token',
        accessTokenRequired: 'Access token 为必填项',
        expiresAtOptional: '过期时间（RFC3339，可选）',
        ok: '确定',
        cancel: '取消',
        close: '关闭',
        save: '保存',
        ...
        activated: '凭证已激活',
        updatedToken: '凭证已更新',
        invalidCredentialId: '无效凭证 ID',
        refreshingLimitsFor: '正在刷新 {label} 的速率限额...',
        limitsRefreshFailed: '刷新速率限额失败：{error}',
        limitsRefreshedFor: '{label} 的速率限额已刷新：{summary}（{detail}）',
        refreshingTokenFor: '正在刷新 {label} 的令牌...',
        tokenRefreshedFor: '{label} 的令牌已刷新',
        tokenRefreshFailed: '刷新令牌失败：{error}',
        deletingCredential: '正在删除凭证 #{id}...',
        credentialDeleted: '凭证已删除',
        refreshing: '刷新中...',
        fetchingLimits: '正在获取速率限额...',
        limitsRefreshed: '速率限额已刷新：{updated} 个更新，{failed} 个失败，{skipped} 个跳过',
        pleasePasteJson: '请先粘贴 JSON',
        invalidJson: '无效 JSON',
        importFailed: '导入失败：{error}',
        importDone: '导入：新增 {created}，更新 {updated}，跳过 {skipped}，失败 {failed}',
        openingFilePicker: '正在打开文件选择器...',
        noFilesSelected: '未选择文件',
        noFilesSelectedHint: '未选择文件。',
        importFilesDone: '导入文件：新增 {created}，更新 {updated}，跳过 {skipped}，失败 {failed}',
        importFilesFailed: '导入文件失败：{error}',
        window: '窗口',
        shortWindow: '短窗口',
        unlimited: '无限',
        balance: '余额 {balance}',
