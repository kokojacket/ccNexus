export default {
    ...
    modal: {
        ...
        modelHelpOpenAI2: 'Optional: Override the OpenAI model (Responses API) specified in requests',
        modelHelpGemini: 'Optional: Override the Gemini model specified in requests',
        remark: 'Remark',
    ...
    tokenPool: {
        ...
        codexProxyTip: 'Only applies to Codex requests and credential refresh',
        proxyUpdated: 'Codex proxy updated',
        proxyCleared: 'Codex proxy cleared',
        proxyLoadFailed: 'Failed to load Codex proxy: {error}',
        proxySaveFailed: 'Failed to save Codex proxy: {error}',
        batchImportJson: 'Batch Import JSON',
        overwriteExisting: 'Overwrite existing account/email',
        pasteJsonPlaceholder: 'Paste one object / array / {"items":[...]}',
        ...
        usingCredentialPool: 'Using credential pool',
        view: 'View',
        enable: 'Enable',
        disable: 'Disable',
        more: 'More',
        ...
        clear: 'Clear',
        copied: 'Copied!',
        changeLevelFailed: 'Failed to change log level',
        ...
        updatedToken: 'Credential updated',
        invalidCredentialId: 'Invalid credential id',
        refreshingLimitsFor: 'Refreshing rate limits for {label}...',
        limitsRefreshFailed: 'Rate limits refresh failed: {error}',
        limitsRefreshedFor: 'Rate limits refreshed for {label}: {summary} ({detail})',
        ...
        fetchingLimits: 'Fetching rate limits...',
        limitsRefreshed: 'Rate limits refreshed: {updated} updated, {failed} failed, {skipped} skipped',
        pleasePasteJson: 'Please paste JSON first',
        invalidJson: 'Invalid JSON',
        importFailed: 'Import failed: {error}',
        importDone: 'Import: +{created}, updated {updated}, skipped {skipped}, failed {failed}',
        openingFilePicker: 'Opening file picker...',
        noFilesSelected: 'No files selected',
        noFilesSelectedHint: 'No files selected.',
        importFilesDone: 'Import files: +{created}, updated {updated}, skipped {skipped}, failed {failed}',
